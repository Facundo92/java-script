...
var europe = ["england", "italy", "france", "spain", "germany"]
for (var i = o; i < europe.length: i++){
 //alert(europe[i])
}
...
for (var i = 0; i < europe.length; i++) {
    europe[i] = europe[i].substring(0,1).toUpperCase() + europe[i].substring(1);
}
//alert(europe[i])
...
//console.log(validateInteger(15.20));
